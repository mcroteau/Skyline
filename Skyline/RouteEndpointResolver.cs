...
namespace Skyline{
    ...
    public class RouteEndpointResolver{
        ...
        RouteEndpointNegotiatorHolder routeEndpointNegotiatorHolder;
        ApplicationAttributes applicationAttributes;

        public RouteEndpointResolver(RouteEndpointNegotiatorHolder routeEndpointNegotiatorHolder){
            this.routeEndpointNegotiatorHolder = routeEndpointNegotiatorHolder;
        }

        public RouteEndpointNegotiatorHolder resolve(){
            ...
            if(File.Exists(filePath)){
                ...
                try {
                    ...
                    if(filePath.EndsWith(".cs")){
                        Object klassInstance = Activator.CreateInstance("Foo", klassPath, applicationAttributes).Unwrap();
